...
public class EMail {
	...
	public static void main(String[] args) {
		EMail eMail = new EMail("1224183237@qq.com", "没有主题", "没有内容");
		eMail.sendMail();
	}
	
	String to = ""; // 收件人
	
	String from = "13866725169@139.com"; // 发件人  这个是发件箱的地址配置，到时候换成你的QQ邮箱
	
	String host = "smtp.10086.cn"; // smtp主机
	
	String username = "13866725169@139.com"; // 用户名
	
	String password = "WANGqun123456"; // 授权码
